...
<div class="page-header">
    <div>
        <h2 class="page-title">Edit Modul: {{ $module->name }}</h2>
        <div class="page-subtitle">Perbarui data konfigurasi modul navigasi sistem</div>
    </div>
...
<div class="card-surface">
    <div class="card-header">
        <span class="user-name-text">Formulir Perubahan Modul</span>
        <span class="badge badge-cyan">ID #{{ $module->id }}</span>
    </div>
            ...
            <div class="form-group">
                <label class="form-check">
                    <input
                        ...
                        {{ old('is_active', $module->is_active ? '1' : '0') == '1' ? 'checked' : '' }}
                    >
