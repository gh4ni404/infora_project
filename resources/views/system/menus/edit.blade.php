<!-- Modal Edit Menu Component -->
<div class="modal-backdrop hidden" id="modalEditMenu" role="dialog" aria-modal="true" aria-labelledby="modalEditMenuTitle">
    <div class="modal-dialog">
        <div class="modal-header">
            <div>
                <h3 class="modal-title" id="modalEditMenuTitle">Formulir Perubahan Menu</h3>
                <p class="modal-subtitle">Perbarui data navigasi menu dan relasi modul dalam platform INFORA</p>
            </div>
            <button type="button" class="modal-close-btn" id="btnCloseEditMenu" aria-label="Tutup Formulir">
        ...
        <form method="POST" action="" id="formEditMenu">
            @csrf
            @method('PUT')
            <div class="modal-body">
                <div class="form-group">
                    <label for="edit_menu_module_id" class="form-label">Induk Modul <span class="text-danger">*</span></label>
                    <select
                        id="edit_menu_module_id"
                        name="module_id"
                ...
                <div class="form-group">
                    <label for="edit_menu_name" class="form-label">Nama Menu <span class="text-danger">*</span></label>
                    <input
                        type="text"
                        id="edit_menu_name"
                        name="name"
                ...
                <div class="form-group">
                    <label for="edit_menu_route_name" class="form-label">Nama Rute (Route Name)</label>
                    <input
                        type="text"
                        id="edit_menu_route_name"
                        name="route_name"
                        list="edit_menu_routes_list"
                        class="form-input @error('route_name') border-danger @enderror"
                        placeholder="Contoh: system.modules, master.data, atau dashboard"
                        value="{{ old('route_name') }}"
                    >
                    <datalist id="edit_menu_routes_list">
                    ...
                    <div class="route-guide-box">
                        ...
                        <div class="route-suggest-pills">
                            ...
                            <button type="button" class="route-suggest-pill" onclick="document.getElementById('edit_menu_route_name').value='dashboard'">dashboard</button>
                            <button type="button" class="route-suggest-pill" onclick="document.getElementById('edit_menu_route_name').value='system.modules'">system.modules</button>
                            <button type="button" class="route-suggest-pill" onclick="document.getElementById('edit_menu_route_name').value='system.menus'">system.menus</button>
                            <button type="button" class="route-suggest-pill" onclick="document.getElementById('edit_menu_route_name').value=''">[Kosongkan - Sebagai Induk]</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <x-icon-picker name="icon" :value="old('icon', 'menu')" id="edit_menu_icon" />
                    @error('icon')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    <label for="edit_menu_order" class="form-label">Urutan Tampil (Order)</label>
                    <input
                        type="number"
                        id="edit_menu_order"
                        name="order"
            ...
            <div class="modal-footer">
                <button type="button" class="btn-secondary" id="btnCancelEditMenu">Batal</button>
