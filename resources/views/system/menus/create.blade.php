...
<div class="page-header">
    <div>
        ...
        <div class="page-subtitle">Daftarkan menu navigasi baru di bawah modul sistem INFORA</div>
    </div>
...
<div class="card-surface">
    <div class="card-header">
        <span class="user-name-text">Formulir Pendaftaran Menu</span>
        <span class="badge badge-cyan">Tata Kelola Menu</span>
    </div>
