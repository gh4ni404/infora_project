            ...
            <div class="modal-body">
                ...
                <div class="form-grid-2col">
                    <div class="form-group">
                        ...
                        <input type="text" id="edit_village" name="village" class="form-input" value="{{ old('village') }}" placeholder="Kelurahan/Desa">
                    </div>
                    <div class="form-group">
                        <label for="edit_district" class="form-label">Kecamatan</label>
                        <input type="text" id="edit_district" name="district" class="form-input" value="{{ old('district') }}" placeholder="Kecamatan">
                    </div>
                    <div class="form-group">
                        <label for="edit_city" class="form-label">Kabupaten / Kota</label>
                        <input type="text" id="edit_city" name="city" class="form-input" value="{{ old('city') }}" placeholder="Kabupaten/Kota">
                    </div>
                    <div class="form-group">
                        <label for="edit_province" class="form-label">Provinsi</label>
                        <input type="text" id="edit_province" name="province" class="form-input" value="{{ old('province') }}" placeholder="Provinsi">
                    </div>
                    <div class="form-group">
                        <label for="edit_postal_code" class="form-label">Kode Pos</label>
                        <input type="text" id="edit_postal_code" name="postal_code" class="form-input" value="{{ old('postal_code') }}" maxlength="10" placeholder="Kode Pos">
                    </div>
                </div>
