...
## 🔐 Fase 2: Design System, Autentikasi & Multi-Role RBAC
- [ ] **2.1. Desain Sistem & Arsitektur Dedicated Layout (Desktop & Mobile)**
  ...
  - [ ] Siapkan komponen UI master: Bottom Navigation Bar (Mobile), Sidebar adaptif (Desktop), Button, Badge status, Modal, dan Card Glassmorphism.
...
- [ ] **2.2. Autentikasi & Manajemen Hak Akses (RBAC & API Tokens)**
  - [ ] Setup Laravel Breeze & Laravel Sanctum untuk autentikasi ganda (Web Session & API Tokens).
  - [ ] Integrasikan Spatie Permission (7 Roles: Super Admin, Kepala Sekolah, Waka, Guru, Siswa, Wali Murid, Asesor).
  - [ ] Halaman Login beranimasi dengan branding INFORA.
  - [ ] Dynamic Redirect Dashboard & API Token Issuance sesuai peran yang login.
...
- [ ] **3.1. Master Data Sekolah & Sivitas**
  ...
  - [ ] CRUD Data Siswa (NISN, Nama, Kelas, Biodata lengkap).
  - [ ] CRUD Data Guru & Tenaga Kependidikan (NIP, Mata Pelajaran, Status Kepegawaian).
...
- 🎨 **[DESIGN.md](DESIGN.md):** Spesifikasi arsitektur teknis, sistem peran (RBAC), dan skema basis data.
