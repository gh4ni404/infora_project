...
class UpdateKecamatanRequest extends FormRequest
{
    ...
    {
        /** @var Kecamatan|string|int|null $kecamatanParam */
        $kecamatanParam = $this->route('kecamatan');
        $kecamatanId = $kecamatanParam instanceof Kecamatan ? $kecamatanParam->id : $kecamatanParam;
        ...
        return [
            ...
            'kode' => [
                ...
                'size:6',
                'regex:/^[0-9]{6}$/',
                Rule::unique('kecamatan', 'kode')->ignore($kecamatanId),
            ],
