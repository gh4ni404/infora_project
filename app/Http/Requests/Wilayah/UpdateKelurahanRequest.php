...
class UpdateKelurahanRequest extends FormRequest
{
    ...
    {
        /** @var Kelurahan|string|int|null $kelurahanParam */
        $kelurahanParam = $this->route('kelurahan');
        $kelurahanId = $kelurahanParam instanceof Kelurahan ? $kelurahanParam->id : $kelurahanParam;
        ...
        return [
            ...
            'kode' => [
                ...
                'size:10',
                'regex:/^[0-9]{10}$/',
                Rule::unique('kelurahan', 'kode')->ignore($kelurahanId),
            ],
